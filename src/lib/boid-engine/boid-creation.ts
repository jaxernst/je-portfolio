...
const attributeRanges: AttributeProbabilityDistribution<Partial<BoidAttrs>> = {
  mass: { min: 0.07, max: 0.3, mean: 0.14, stdev: 0.05, skew: 0 },
  ...
  separationDistance: { min: 5, max: 200, mean: 110, stdev: 50, skew: 0 },
  separationFactor: { min: 0.5, max: 5, mean: 3, stdev: 0.2, skew: 0 },
  gravitationFactor: { min: 0.1, max: 2, mean: 0.35, stdev: 0.5, skew: 0 },
  alignmentFactor: { min: 0.04, max: 0.5, mean: 0.15, stdev: 0.08, skew: 0 },
};
