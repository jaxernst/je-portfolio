...
const attributeRanges: AttributeProbabilityDistribution<Partial<BoidAttrs>> = {
  mass: { min: 0.05, max: 0.3, mean: 0.15, stdev: 0.1, skew: 0 },
  targetV: { min: 5, max: 200, mean: 100, stdev: 50, skew: 0 },
  ...
  separationDistance: { min: 5, max: 100, mean: 30, stdev: 20, skew: 0 },
  separationFactor: { min: 0.5, max: 3, mean: 2, stdev: 0.5, skew: 0 },
  gravitationFactor: { min: 0.1, max: 2, mean: 0.8, stdev: 0.5, skew: 0 },
  alignmentFactor: { min: 0.05, max: 0.5, mean: 0.1, stdev: 0.4, skew: 0 },
  forceSmoothing: { min: 0, max: 20, mean: 5, stdev: 5, skew: 0 },
};
